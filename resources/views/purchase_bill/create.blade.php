        ...
        <div class="col-md-12 grid-margin stretch-card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ \App\Purchase::max('id')+1 }}" id="name" name="name" readonly reqiured>
                </div>
                <div class="form-group">
                ...
                <?php $total = 0; ?>
                @foreach (\App\PurchaseDetail::where("purchase_id",\App\Purchase::max('id')+1)->get() as $sales_bill)
                ...
                <hr>
                   <div class="card">
                        <h3 class="card-title p-4 m-0"><a href="{{ route('purchase_detail.create') }}" style="float: left;" class="btn btn-success pull-rigth">إضافة منتج</a>  تفاصيل الفاتورة</h3>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group" dir="ltr" aria-label="Basic example">
                                                        <a href="{{ route('purchase_detail.delete',$sales_bill->id) }}" title="حذف" class="btn btn-danger delete"><i class="mdi mdi-delete-forever" ></i></a>
                                                        <a href="{{ route('purchase_detail.edit', $sales_bill->id) }}" title="تعديل" class="btn btn-success"><i class="mdi mdi-lead-pencil" ></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
