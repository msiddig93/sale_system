...
@section('title')
    إضافة تفاصيل الي طلب المشتريات
@stop
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="mr-md-3 mr-xl-5">
                        <h2>إضافة تفاصيل الي طلب المشتريات</h2>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            ...
            <div class="card-body">
                ...
                {{--  @enderror  --}}
                <form class="forms-sample" action="{{ route('purchase_detail.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group text-center" >
                    ...
                    <a href="{{ route('purchase.create') }}" class="btn btn-defualt">إلغاء</a>
                </div>
